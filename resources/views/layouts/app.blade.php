...
<body>
    ...
    <footer class="border border-light" style="margin-top:5px !important;"><center><a href="#" target="_blank"><p class="heart">Made with&nbsp;<i class="fa fa-heart fa-2x fa-beat text-danger"></i>&nbsp;In India </p></a></center></footer>
    </body>
</html>
