...
<div class="row">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{route('course.update',$course->id)}}" enctype="multipart/form-data" method="POST">@csrf
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="course_name">Course Name</label>
                            <input type="text" class="form-control" required name="course_name" id="course_name"
                                aria-describedby="helpId" value="{{$course->course_name}}">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control" name="course_feat_img" id="course_feat_img" placeholder=""
                                aria-describedby="fileHelpId" value="{{$course->course_feat_img}}">
                            <small id="fileHelpId" class="form-text text-muted">Select the Featured Image ex:bca</small>
                            @isset($course->course_feat_img)
                                 <a href="{{$course->course_feat_img}}" target="_blank"><img class="img-fluid" src="{{$course->course_feat_img}}" alt="{{$course->course_name}}"></a>
                             @endisset
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <textarea class="form-control summernote" name="course_discription" id="course_discription"
                                rows="3">{{$course->course_discription}}</textarea>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label for="student_learn">What Will Student Learn</label>
                            <textarea class="form-control summernote" name="student_learn" id="student_learn" rows="3">{{$course->student_learn}}</textarea>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control summernote" name="course_outcome" id="course_outcome"
                                rows="3">{{$course->course_outcome}}</textarea>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" required name="no_of_lession" id="no_of_lession"
                                aria-describedby="helpId" value="{{$course->no_of_lession}}">
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" required name="duration" id="duration"
                                aria-describedby="helpId" value="{{$course->duration}}" >
                    ...
                    <div class="col-3">
                        <div class="form-group">
                          ...
                          <select class="form-control" required name="prequisite" id="prequisite">
                            ...
                            <option value="YES" {{ ( $course->prequisite == 'YES') ? 'selected' : '' }}>YES</option>
                            <option value="NO" {{ ( $course->prequisite == 'NO') ? 'selected' : '' }}>NO</option>
                          </select>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="form-group">
                          ...
                          <select class="form-control" required name="certification" id="certification">
                            <option value="" selected>SELECT</option>
                            <option value="YES" {{ ( $course->certification == 'YES') ? 'selected' : '' }}>YES</option>
                            <option value="NO" {{ ( $course->certification == 'NO') ? 'selected' : '' }}>NO</option>
                          </select>
                        </div>
                    </div>
                    <div class="col-6">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" value="{{$course->price}}" name="price" id="price" aria-describedby="helpId" placeholder="1200 ₹">
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control summernote" name="course_curricularm" id="course_curricularm"rows="3">{{$course->course_curricularm}}</textarea>
                        </div>
                    </div>
                </div>
